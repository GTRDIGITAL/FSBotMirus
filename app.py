...
def FS_process():
	...
	if request.method == 'POST':
		...
		if(option2==0):
			...
			test.cell(row=10,column=1).value='''=IF(SUMIF(D:D,641,J:J)>0,IF(OR('3. F30'!F44,'3. F30'!F45=""),"Trebuie introduse sume in F30 ",0),0)'''
			...
			test.cell(row=10,column=1).value="=IF(SUMIF(D:D,641,J:J)>0,1,0)"
			test.cell(row=10,column=2).value="=IF(OR('3. F30'!D47,'3. F30'!D48=""),1,0)"
